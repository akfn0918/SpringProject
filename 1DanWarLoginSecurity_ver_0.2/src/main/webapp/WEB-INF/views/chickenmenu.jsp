...
<img src="./img/chicken.png" class="float-center" width="200" height="200" style="margin-left:40%"/>
              </div>
      ...
      <div class="card-group" style="padding:10px">
            ...
            <div class="col-half">
              <div class="card info-card sales-card">
                ...
                <div class="card-body" style="padding:10px">
                  <h5 class="card-title"> 푸라닭 <span>| 종로3가점</span></h5>

                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <img src="./img/puradak.PNG">
                    ...
                    <div class="text-center"><a class="btn btn-outline-dark mt-auto stretched-link" style="margin-left:400px" href="puradakshop.jsp">선택</a></div>
                </div>
              </div>
            </div>
            ...
            <div class="col-half">
              <div class="card info-card sales-card">
                ...
                <div class="card-body" style="padding:10px">
                  <h5 class="card-title"> 교촌치킨 <span>| 종로3가점</span></h5>

                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <img src="./img/kyochon.PNG">
                    ...
                    <div class="text-center"><a class="btn btn-outline-dark mt-auto stretched-link" style="margin-left:400px" href="kyochonshop.jsp">선택</a></div>
                </div>
              </div>
            </div>
            ...
            <div class="col-half">
              <div class="card info-card sales-card">
                ...
                <div class="card-body" style="padding:10px">
                  <h5 class="card-title"> 처갓집치킨 <span>| 종로3가점</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="text-center"><a class="btn btn-outline-dark mt-auto stretched-link" style="margin-left:400px" href="jipshop.jsp">선택</a></div>
                </div>
              </div>
            </div>                    
        </div>
