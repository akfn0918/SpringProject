...
<img src="./img/ricecake.png" class="float-center" width="200" height="200" style="margin-left:40%"/>
              </div>
      ...
      <div class="card-group" style="padding:10px">
            ...
            <div class="col-half">
              <div class="card info-card sales-card">
                ...
                <div class="card-body" style="padding:10px">
                  <h5 class="card-title"> 동대문 엽기떡볶이 <span>| 종로3가점</span></h5>

                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <img src="./img/dongdaemoon.PNG">
                    ...
                    <div class="text-center"><a class="btn btn-outline-dark mt-auto stretched-link" style="margin-left:400px" href="dongdaemoonshop.jsp">선택</a></div>
                </div>
              </div>
            </div>
            ...
            <div class="col-half">
              <div class="card info-card sales-card">
                ...
                <div class="card-body" style="padding:10px">
                  <h5 class="card-title"> 배떡 <span>| 종로3가점</span></h5>

                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <img src="./img/baedduk.PNG">
                    ...
                    <div class="text-center"><a class="btn btn-outline-dark mt-auto stretched-link" style="margin-left:400px" href="baeddukshop.jsp">선택</a></div>
                </div>
              </div>
            </div>
            ...
            <div class="col-half">
              <div class="card info-card sales-card">
                ...
                <div class="card-body" style="padding:10px">
                  <h5 class="card-title"> 신전떡볶이 <span>| 종로3가점</span></h5>

                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <img src="./img/sinjeon.PNG">
                    ...
                    <div class="text-center"><a class="btn btn-outline-dark mt-auto stretched-link" style="margin-left:400px" href="sinjeonshop.jsp">선택</a></div>
                </div>
              </div>
            </div>                   
        </div>
